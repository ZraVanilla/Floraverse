...
- Name: floraverse-smoke.spec.js >> index.html loads without runtime errors
- Location: ..\Users\User\AppData\Local\Temp\opencode\floraverse-smoke.spec.js:16:3

# Error details

```
Error: page.goto: net::ERR_EMPTY_RESPONSE at http://localhost:8010/index.html
Call log:
  - navigating to "http://localhost:8010/index.html", waiting until "load"
