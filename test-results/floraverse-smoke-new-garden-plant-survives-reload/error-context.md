...
- Name: floraverse-smoke.spec.js >> new garden plant survives reload
- Location: ..\Users\User\AppData\Local\Temp\opencode\floraverse-smoke.spec.js:34:1

# Error details

```
Error: page.goto: net::ERR_EMPTY_RESPONSE at http://localhost:8010/garden.html
Call log:
  - navigating to "http://localhost:8010/garden.html", waiting until "load"
