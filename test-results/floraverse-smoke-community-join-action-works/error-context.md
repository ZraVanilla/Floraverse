...
- Name: floraverse-smoke.spec.js >> community join action works
- Location: ..\Users\User\AppData\Local\Temp\opencode\floraverse-smoke.spec.js:25:1

# Error details

```
Error: page.goto: net::ERR_EMPTY_RESPONSE at http://localhost:8010/community.html
Call log:
  - navigating to "http://localhost:8010/community.html", waiting until "load"
