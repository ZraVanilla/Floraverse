...
const PLANTS = [
  ...
  },
  {
    ...
    color:"#FF9B70", emoji:"🌶️", desc:"Cabai merah keriting ideal untuk masakan harian, buah lebat dan perawatan mudah.", cara:"Sama seperti cabai rawit, butuh pot minimal 20cm.", perawat:"Butuh ajir saat mulai berbuah.", hama:"Thrips, tungau", tips:"Jemur benih sebelum semai agar germinasi tinggi.", rating:4.7, buyers:980
  },
  {
    ...
    color:"#FF718D", emoji:"🍅", desc:"Tomat cherry manis, cocok untuk pot dan balkon. Buah kecil menggantung cantik.", cara:"Semai, pindah tanam, beri ajir, pangkas tunas air.", perawat:"Siram pagi, hindari daun basah malam.", hama:"Late blight, kutu kebul", tips:"Panen bertahap, petik saat merah mengkilap.", rating:4.9, buyers:1520
  },
  {
    ...
    color:"#8BCB8A", emoji:"🥬", desc:"Selada romaine renyah, cepat panen, ideal untuk hidroponik pemula.", cara:"Semai di rockwool, pindah ke netpot hidroponik hari ke-7.", perawat:"Jaga nutrisi AB Mix, pH stabil.", hama:"Siput, aphid", tips:"Panen daun luar dulu agar terus tumbuh.", rating:4.6, buyers:840
  },
  {
    ...
    color:"#8BCB8A", emoji:"🥬", desc:"Bayam tumbuh sangat cepat, cocok untuk panen kilat di halaman sempit.", cara:"Tabur langsung, jarang 10cm.", perawat:"Siram 2x sehari musim kemarau.", hama:"Ulat grayak", tips:"Panen sebelum berbunga agar tidak pahit.", rating:4.5, buyers:610
  },
  {
    ...
    color:"#8BCB8A", emoji:"🥬", desc:"Kangkung darat paling toleran, bahkan bisa tanpa perawatan intensif.", cara:"Tabur benih langsung.", perawat:"Siram rutin, pupuk kompos.", hama:"Belalang", tips:"Potong 5cm dari pangkal, akan tumbuh lagi.", rating:4.7, buyers:720
  },
  {
    ...
    color:"#FF9B70", emoji:"🥕", desc:"Wortel Nantes manis, umbi lurus, butuh media dalam dan gembur.", cara:"Tabur langsung, jangan pindah tanam.", perawat:"Jarang agar jarak 5cm, gemburkan tanah.", hama:"Lalat wortel", tips:"Panen saat ujung umbi nongol.", rating:4.4, buyers:430
  },
  {
    ...
    color:"#FF718D", emoji:"🍓", desc:"Stroberi manis-asam, cantik untuk pot gantung.", cara:"Bibit stolon, tanam di pot 20cm.", perawat:"Siram pagi, mulsa jerami.", hama:"Tungau, busuk buah", tips:"Buang bunga pertama agar tanaman kuat.", rating:4.8, buyers:890
  },
  {
    ...
    color:"#8BCB8A", emoji:"🥒", desc:"Mentimun baby renyah, rajin berbuah jika diberi rambatan.", cara:"Tabur 2 benih/lubang, beri ajir.", perawat:"Siram rutin, pupuk K tinggi saat berbuah.", hama:"Embun tepung", tips:"Panen muda agar tidak pahit.", rating:4.5, buyers:560
  },
  {
    ...
    color:"#6FA8FF", emoji:"🍆", desc:"Terong ungu produktif, satu tanaman bisa panen berkali-kali.", cara:"Semai lalu pindah tanam 30x40cm.", perawat:"Pangkas daun bawah, pupuk rutin.", hama:"Kumbang terong", tips:"Petik saat kulit mengkilap.", rating:4.6, buyers:480
  },
  {
    ...
    color:"#8BCB8A", emoji:"🌿", desc:"Basil wangi untuk pasta dan teh, tumbuh cepat di pot kecil.", cara:"Tabur, jarang, panen pucuk.", perawat:"Cubit pucuk agar rimbun.", hama:"Siput", tips:"Jangan biarkan berbunga agar daun tetap wangi.", rating:4.9, buyers:1020
  },
  {
    ...
    color:"#8BCB8A", emoji:"🌿", desc:"Kemangi lokal wangi kuat, pendamping pecel dan lalapan.", cara:"Tabur langsung.", perawat:"Siram 1x sehari.", hama:"Hampir tidak ada", tips:"Panen pagi hari aroma paling kuat.", rating:4.7, buyers:670
  },
  {
    ...
    color:"#FF718D", emoji:"🌹", desc:"Mawar floribunda rajin berbunga, warna cerah.", cara:"Stek atau bibit okulasi, pot 25cm.", perawat:"Pangkas setelah berbunga, pupuk NPK.", hama:"Thrips, black spot", tips:"Pangkas miring 45° di atas mata tunas.", rating:4.7, buyers:540
  },
  {
    ...
    color:"#FFD45C", emoji:"🌻", desc:"Bunga matahari ceria, tinggi dan mencolok, disukai lebah.", cara:"Tabur langsung 30cm.", perawat:"Beri ajir jika tinggi >1m.", hama:"Ulat grayak", tips:"Tanam berurutan tiap 2 minggu untuk bunga terus.", rating:4.8, buyers:610
  },
  {
    ...
    color:"#8BCB8A", emoji:"🌵", desc:"Kaktus mini tahan lupa siram, cocok untuk meja kerja.", cara:"Bibit anakan, media poros.", perawat:"Siram 7–10 hari sekali.", hama:"Busuk akar jika overwater", tips:"Jemur 4–6 jam sehari.", rating:4.6, buyers:780
  },
  {
    ...
    color:"#8BCB8A", emoji:"🪴", desc:"Sukulen roset cantik, warna pastel.", cara:"Daun diperbanyak, letak terang.", perawat:"Siram saat media kering.", hama:"Mealybug", tips:"Jangan semprot daun, siram ke media.", rating:4.7, buyers:920
  },
  {
    ...
    color:"#FFD45C", emoji:"🥭", desc:"Mangga harum manis legendaris, bisa tabulampot.", cara:"Bibit okulasi, pot 50cm.", perawat:"Pangkas bentuk, pupuk buah.", hama:"Lalat buah", tips:"Bungkus buah saat pentil.", rating:4.8, buyers:310
  },
  {
    ...
    color:"#FFD45C", emoji:"🍊", desc:"Jeruk mini rajin berbuah, asam segar untuk minuman.", cara:"Bibit cangkok, pot 30cm.", perawat:"Pupuk NPK buah.", hama:"Kutu daun", tips:"Panen saat oranye penuh.", rating:4.6, buyers:420
  },
  {
    ...
    color:"#FF718D", emoji:"🍎", desc:"Jambu air madu manis berair.", cara:"Cangkok, tanam halaman.", perawat:"Siram rutin musim kering.", hama:"Lalat buah", tips:"Bungkus buah dengan plastik.", rating:4.5, buyers:280
  },
  {
    ...
    color:"#8BCB8A", emoji:"🥑", desc:"Alpukat mentega pulen, nilai ekonomi tinggi.", cara:"Bibit okulasi.", perawat:"Jangan genang.", hama:"Ulat kipat", tips:"Panen saat kulit agak kusam.", rating:4.9, buyers:340
  },
  {
    ...
    color:"#6FA8FF", emoji:"🌸", desc:"Lavender wangi menenangkan, butuh drainase bagus.", cara:"Semai, pindah pot 15cm.", perawat:"Jangan overwater.", hama:"Busuk akar", tips:"Pangkas bunga kering untuk pembungaan ulang.", rating:4.6, buyers:390
  },
  {
  ...
  },
  {
    ...
    color:"#8BCB8A", emoji:"🪴", desc:"Lidah buaya multifungsi, tahan banting.", cara:"Anakan, pot 15cm.", perawat:"Siram 10 hari sekali.", hama:"Hampir tidak ada", tips:"Gel bisa untuk luka ringan.", rating:4.7, buyers:660
  },
  {
